...
import { userService } from "../lib/services"; // Import userService
...
const UserPage = () => {
  ...
  const fetchWatchlist = async () => {
    try {
      const response = await userService.get(`/watchlist?uid=${user.uid}`);
  ...
  const fetchWatchedMovies = async () => {
    try {
      const response = await userService.get(`/watched?uid=${user.uid}`);
  ...
  const removeFromWatchlist = async (movieId) => {
    try {
      await userService.delete(
        `/watchlist/remove?uid=${user.uid}&movieId=${movieId}`
      );
      fetchWatchlist();
    } catch (error) {
  ...
  const clearWatchlist = async () => {
    try {
      await userService.delete(`/watchlist/clear?uid=${user.uid}`);
      setWatchlist([]);
    } catch (error) {
  ...
  const removeFromWatched = async (movieId) => {
    try {
      await userService.delete(
        `/watched/remove?uid=${user.uid}&movieId=${movieId}`
      );
      fetchWatchedMovies();
    } catch (error) {
  ...
  const clearWatchedMovies = async () => {
    try {
      await userService.delete(`/watched/clear?uid=${user.uid}`);
      setWatchedMovies([]);
    } catch (error) {
      ...
      <div className="content">
        ...
        {activeTab === "watched" && (
          <div>
            ...
            <button onClick={clearWatchedMovies} className="clear-btn">
